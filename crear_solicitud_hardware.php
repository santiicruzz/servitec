...
if (isset($_SESSION['user_id'])) {
    ...
    if (
        ...
        $sql = "INSERT INTO solicitud (fk_tecnico, fk_cliente, fk_estado, fk_tipo, descripcion, direccion, fecha, numero) VALUES (null,'$_SESSION[user_id]', 2, 2, :desc, :direccion, :fecha, :telefono)";
        $conn = new Database();
